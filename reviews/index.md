...
layout: sub-index
title: REVIEWS
subheading: In-depth, long-form reviews of media, products, and experiences. Variable length, but usually 500-2000 words.
---
...
<main class="dense-list-layout">
    {% assign posts = site.pages | where_exp: "item", "item.path contains 'reviews/'" | where_exp: "item", "item.path contains '.html'" | sort: "date" | reverse %}
