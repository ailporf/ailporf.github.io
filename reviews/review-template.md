...
# --- LIFECYCLE COMPONENT ---
tier: "C"                     # SSS, S, A, B, C, D, F (Gut enjoyment value)
engine: "Character-Driven"        # Character-Driven, Setting-Driven, Plot-Driven, Theme-Driven
character_logic: "Fluid"       # Rigid (Acts logically) or Fluid (Acts for plot armor)
...
eroticism_score: 9/10             # Standard 1 to 10 scale
